...
public class generator{
	...
	public static String generate(int a, rand_gen c) {
		...
		String result = "";
		String[][] full = {
				/*Caster */{"turns to stone","bursts into flame","gains 10d6 gold","gains 10d8 gold","gains 10d10 gold","gains 10d100 gold", "loses their teeth", "ages 5d4 years", "de-ages 5d4 years", "ages 5d8 years", "de-ages 5d8 years", "has teeth turn into gold", "dies", "can ignite things at will", "turns ethereal for 1d10 turns or ten minutes", "is teleported to the astral plane","is teleported to the fire plane","is teleported to the air plane","is teleported to the earth plane","is teleported to the water plane","explodes. everyone in a 15ft radius must make a dex save(14) or suffer 6d8 damage", "turns into ice", "is constantly moist", "gains +2 in stat of choice", "gets a -2 in stat of choice", "suffers from onset dementia", "has truesight up to 60ft", "is blind", "experiences Mesothelioma and may be entitled to fincaial compensation", "recovers all health", "gains 2d8 health permanantly", "loses all health", "loses 2d8 health permanantly", "loses a proficency of their choice", "gains a proficency of their choice", "levels up", "has zero experience"},
				...
				/*Random object belonging to caster */{"a","a","a"},
				/*Random object belonging to target*/{"a","a","a"},
